...
//  }
//}
$title = 'Top '.$SelectTop.' Departments'.$title;
if ($args['type'] == 'PIE')
{
  $pie = new graph();
  ...
  $pie->pie_values(array_slice($jobs->data, 0, $SelectTop),
                   array_slice($jobs->DepNames, 0, $SelectTop),
...
elseif ($args['type'] == 'BARS')
{
  ...
  $chart->data_sets[] = $bar;
  $chart->set_x_labels(array_slice($jobs->DepNames, 0, $SelectTop));
